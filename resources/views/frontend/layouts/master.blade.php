...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title') {{config ('app.name', 'Shopspace')}} </title>
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
          ...
          <aside id="cart-sidebar"
            class="fixed inset-0 z-50 bg-gray-800/50 text-white p-4 rounded-lg shadow-lg m-4 translate-x-full transform duration-300 ease-linear">
            
            <div class="min-w-52 w-fit h-full ml-auto bg-white rounded-lg shadow-lg overflow-hidden text-black">
                
                <div class="container mx-auto px-4 py-8 max-w-3xl">

                    <button id="close-cart-sidebar" class="flex items-center gap-1 p-2 rounded hover:bg-gray-200">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-gray-100 px-6 py-4 border-b">
                            <h1
                                class="text-2xl font-semibold text-gray-800">Your
                                Cart</h1>
                        </div>
                        ...
                        <div class="divide-y divide-gray-200">
                            <!-- Item -->
                            <div
                                class="p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                                <!-- Left: Image + Info -->
                                <div class="flex items-center gap-4 flex-1">
                                    <img src="./eimage/crypgo (15).jpg"
                                        alt="Product"
                                        class="w-20 h-40 object-cover rounded border">
                                    <div>
                                        <h3
                                            class="text-lg font-medium text-gray-800">Product
                                            Name</h3>
                                        <p class="text-gray-600 mt-1">Unit
                                            Price: $9.99</p>
                                        <div
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    <p
                                        class="text-lg font-semibold text-gray-800">$19.98</p>
                                    <button
                            ...
                            <!-- More Items... (Duplicate above div with different data) -->
                        </div>
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                <span
                                    class="font-semibold text-gray-700">Subtotal</span>
                                <span
                                    class="font-semibold text-gray-800">$39.96</span>
                            </div>
                            <button
...
<!-- // Dropdown show/hide forms logic -->
     <script>      
